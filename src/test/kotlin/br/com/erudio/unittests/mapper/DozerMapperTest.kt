...
class DozerMapperTest {
    ...
    fun parseEntityToVOTest() {
        ...
        assertEquals("First Name Test0", output.primeiroNome)
        assertEquals("Last Name Test0", output.ultimoNome)
        assertEquals("Address Test0", output.addres)
    ...
    fun parseEntityListToVOListTest() {
        ...
        assertEquals("First Name Test0", outputZero.primeiroNome)
        assertEquals("Last Name Test0", outputZero.ultimoNome)
        assertEquals("Address Test0", outputZero.addres)
        assertEquals("Male", outputZero.gender)

        val outputSeven: PersonVO = outputList[7]
        assertEquals(7.toLong(), outputSeven.id)
        assertEquals("First Name Test7", outputSeven.primeiroNome)
        assertEquals("Last Name Test7", outputSeven.ultimoNome)
        assertEquals("Address Test7", outputSeven.addres)
        assertEquals("Female", outputSeven.gender)

        val outputTwelve: PersonVO = outputList[12]
        assertEquals(12.toLong(), outputTwelve.id)
        assertEquals("First Name Test12", outputTwelve.primeiroNome)
        assertEquals("Last Name Test12", outputTwelve.ultimoNome)
        assertEquals("Address Test12", outputTwelve.addres)
